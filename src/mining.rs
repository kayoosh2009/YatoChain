...
pub fn calculate_difficulty(active_users: usize) -> usize {
    match active_users {
        0..=5 => 3,    // 0-5 пользователей: сложность 3
        6..=15 => 4,   // 6-15 пользователей: сложность 4
        16..=30 => 5,  // 16-30 пользователей: сложность 5
        31..=50 => 6,  // 31-50 пользователей: сложность 6
